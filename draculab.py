...
class unit_types(Enum):
    ...
    def get_class(self):
        ...
        # Models from spinal
        ...
        elif self == unit_types.gated_out_norm_sig:
            from units.spinal_units import gated_out_norm_sig 
            unit_class = gated_out_norm_sig
        elif self == unit_types.bell_shaped_1D:
            from units.spinal_units import bell_shaped_1D
            unit_class = bell_shaped_1D
        elif self == unit_types.td_sigmo:
            from units.spinal_units import td_sigmo
            unit_class = td_sigmo
        elif self == unit_types.layer_dist:
            from units.spinal_units import layer_dist
            unit_class = layer_dist
        elif self == unit_types.m_sig:
            from units.spinal_units import m_sig 
            unit_class = m_sig
        elif self == unit_types.linear_mplex:
            from units.spinal_units import linear_mplex
            unit_class = linear_mplex 
        elif self == unit_types.x_sig:
            from units.spinal_units import x_sig 
            unit_class = x_sig
            ...
            unit_class = x_netC
        elif self == unit_types.x_netD:
            from units.spinal_units import x_netD
            unit_class = x_netD
        elif self == unit_types.x_netE:
            from units.spinal_units import x_netE
            unit_class = x_netE
        ...
        elif self == unit_types.adapt_m_sig:
            from units.spinal_units import adapt_m_sig
            unit_class = adapt_m_sig
        else:
...
class synapse_types(Enum):
    ...
    gated_rga_21 = 221 # rga_21 with gated learning rate
    gated_rga_21_dc = 222 # rga_21 with an extra differential correlation
    gated_normal_rga_21 = 223 # rga_21, gated learning rate, normalized inputs
    gated_normal_rga_diff_dc = 224 # gnrd with an extra differential correlation
    ...
    def get_class(self):
        ...
        # Synapses for the spinal model
            ...
            syn_class = rga_21
        elif self == synapse_types.gated_rga_21:
            from synapses.spinal_syns import gated_rga_21
            syn_class = gated_rga_21
        elif self == synapse_types.gated_rga_21_dc:
            from synapses.spinal_syns import gated_rga_21_dc
            syn_class = gated_rga_21_dc
        elif self == synapse_types.gated_normal_rga_21:
            from synapses.spinal_syns import gated_normal_rga_21
            syn_class = gated_normal_rga_21
        elif self == synapse_types.gated_normal_rga_diff_dc:
            from synapses.spinal_syns import gated_normal_rga_diff_dc
            syn_class = gated_normal_rga_diff_dc
        elif self == synapse_types.noisy_gated_normal_rga_diff:
            from synapses.spinal_syns import noisy_gated_normal_rga_diff
            syn_class = noisy_gated_normal_rga_diff
        elif self == synapse_types.noisy_gated_diff_inp_sel:
            from synapses.spinal_syns import noisy_gated_diff_inp_sel
